...
public class TaskBookService {
  ...
  public interface AsyncIface {
    ...
    public void groupInfo(int groupId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void taskInfo(int taskId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public ThriftGroupInfo groupInfo(int groupId) throws org.apache.thrift.TException
    {
      send_groupInfo(groupId);
      return recv_groupInfo();
    }

    public void send_groupInfo(int groupId) throws org.apache.thrift.TException
    {
    ...
    public ThriftTaskInfo taskInfo(int taskId) throws org.apache.thrift.TException
    {
      send_taskInfo(taskId);
      return recv_taskInfo();
    }

    public void send_taskInfo(int taskId) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void groupInfo(int groupId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      groupInfo_call method_call = new groupInfo_call(groupId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class groupInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int groupId;
      public groupInfo_call(int groupId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public void taskInfo(int taskId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      taskInfo_call method_call = new taskInfo_call(taskId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class taskInfo_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int taskId;
      public taskInfo_call(int taskId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.taskId = taskId;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class groupInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, groupInfo_args> {
      ...
      public groupInfo_result getResult(I iface, groupInfo_args args) throws org.apache.thrift.TException {
        groupInfo_result result = new groupInfo_result();
        result.success = iface.groupInfo(args.groupId);
        return result;
      }
    }
    ...
    public static class taskInfo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, taskInfo_args> {
      ...
      public taskInfo_result getResult(I iface, taskInfo_args args) throws org.apache.thrift.TException {
        taskInfo_result result = new taskInfo_result();
        result.success = iface.taskInfo(args.taskId);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class groupInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, groupInfo_args, ThriftGroupInfo> {
      ...
      public void start(I iface, groupInfo_args args, org.apache.thrift.async.AsyncMethodCallback<ThriftGroupInfo> resultHandler) throws TException {
        iface.groupInfo(args.groupId,resultHandler);
      }
    }
    ...
    public static class taskInfo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, taskInfo_args, ThriftTaskInfo> {
      ...
      public void start(I iface, taskInfo_args args, org.apache.thrift.async.AsyncMethodCallback<ThriftTaskInfo> resultHandler) throws TException {
        iface.taskInfo(args.taskId,resultHandler);
      }
    }
