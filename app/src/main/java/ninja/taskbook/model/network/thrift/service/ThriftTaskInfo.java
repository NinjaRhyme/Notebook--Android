...
public class ThriftTaskInfo implements org.apache.thrift.TBase<ThriftTaskInfo, ThriftTaskInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftTaskInfo> {
  ...
  public ThriftTaskInfo setTaskTime(String taskTime) {
    this.taskTime = taskTime;
    return this;
  }
  ...
  public boolean equals(ThriftTaskInfo that) {
    ...
    boolean this_present_taskTime = true && this.isSetTaskTime();
    boolean that_present_taskTime = true && that.isSetTaskTime();
    if (this_present_taskTime || that_present_taskTime) {
      if (!(this_present_taskTime && that_present_taskTime))
        return false;
      if (!this.taskTime.equals(that.taskTime))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_taskTime = true && (isSetTaskTime());
